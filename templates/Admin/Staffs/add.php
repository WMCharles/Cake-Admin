                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <textarea name="designation" id="designation" class="form-control" placeholder="Enter Designation"></textarea>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <div class="form-group">
                                            ...
                                            <select required name="staff_type" id="staff_type" class="form-control">
                                                ...
                                                <option value="worshop-instructor">WorKshop-instructor</option>
